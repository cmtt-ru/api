...
* {v} — текущая версия API (на данный момент — `2`);
...
[🚀 Test endpoint](https://api.tjournal.ru/2/account/info?userId=1)
...
[🚀 Test endpoint](https://api.tjournal.ru/2/account/posts?userId=1)
...
[🚀 Test endpoint](https://api.tjournal.ru/2/paper)
...
[🚀 Test endpoint](https://api.tjournal.ru/2/paper/info?paperId=6666)
...
count    | количество | 1 – 50 | 30
offset   | отступ от начала | 0 – ∞ | 0
category | категория | news, offtopic | news
sortMode | вид сортировки | all, recent, popular, discuss, unadmitted | recent
sortModeAdditional | период популярного (передавать только если sortMode = popular) | day, 4days, all | day

[🚀 Test endpoint](https://api.tjournal.ru/2/club?category=news&sortMode=popular)
...
[🚀 Test endpoint](https://api.tjournal.ru/2/club/item?paperId=1234)
...
Параметр | Описание | Варианты | По умолчанию
---------|----------|----------|--------------
count    | количество твитов | 1 – 50 | 30
offset   | отступ от начала | 0 – ∞ | 0
listId   | категория | 1,2,3 | 1
interval | период времени | fresh, popular, week, month | popular

[🚀 Test endpoint](https://api.tjournal.ru/2/tweets?listId=1&interval=fresh&count=50)
...
[🚀 Test endpoint](https://api.tjournal.ru/2/news?listId=1)
...
[🚀 Test endpoint](https://api.tjournal.ru/2/news/lists)



## Прочее
### Отправка опечаток
`POST /2/misprints/new`
...
`GET /2/content/reveal`

Параметр | Описание | Варианты | По умолчанию
---------|----------|----------|--------------
url      | адрес статьи | |

[🚀 Test endpoint](https://api.tjournal.ru/2/content/reveal?url=http%3A%2F%2Ftjournal.ru%2Fpaper%2Fyanavigator-vs-citiguide)